...
//               <span className="contact__card-data">kallurutanveer000@gmail.com</span>
//               <a href="mailto:kallurutanveer000@gmail.com" className="contact__button">
...
//               <span className="contact__card-data">@Tanveer_Kalluru</span>
//               <a href="https://t.me/Tanveer_Kalluru" target="_blank" rel="noreferrer" className="contact__button">
        ...
        <div className="contact__content">
          ...
          <div className="contact__cards grid">
            ...
            <div className="contact__card">
              <h3 className="contact__card-title">Telegram</h3>
              <span className="contact__card-data">@Tanveer_Kalluru</span>
              <a href="https://t.me/Tanveer_Kalluru" target="blank" rel="noreferrer" className="contact_button">
                Chat with me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
          </div>
